...
#ifdef CONFIG_RAM_1G_512M
#define SPRD_SYSDUMP_MAGIC      ((PHYS_OFFSET_ADDR & (~(SZ_1G_512M - 1))) + SZ_1G_512M - SZ_1M)
#elif CONFIG_RAM1024M
#define SPRD_SYSDUMP_MAGIC      ((PHYS_OFFSET_ADDR & (~(SZ_1024M - 1))) + SZ_1024M - SZ_1M)
#elif defined(CONFIG_RAM512M)
