...
#define CONFIG_COREPRIMELITE_MARLIN
...
#define CONFIG_FB_LCD_HX8369B_MIPI_COREPRIMELITE
...
#include <asm/sizes.h>
#define SPRD_SYSDUMP_MAGIC      ((PHYS_OFFSET_ADDR & (~(SZ_768M - 1))) + SZ_768M - SZ_1M)
