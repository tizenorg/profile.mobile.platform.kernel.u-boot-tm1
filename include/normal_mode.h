...
#if defined (CONFIG_SP8835EB) || defined(CONFIG_FPGA) ||defined(CONFIG_SP8830EB)||defined(CONFIG_SP8830EC)||defined(CONFIG_SP8830GEA)||defined(CONFIG_SC9620OPENPHONE)  //for TD CP1
