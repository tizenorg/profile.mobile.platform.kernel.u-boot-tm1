...
sp9630fpga_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630fpga spreadtrum sc9630

pikelfpga_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 pikelfpga spreadtrum sc9630

sp9630ea_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea spreadtrum sc9630
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk

sp9630ea3mn_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea3mn spreadtrum sc9630
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk

sp9630ea6mn_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea3mn spreadtrum sc9630
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk
...
sp9630ea4mn_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea4mn spreadtrum sc9630
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk

sp9820ea_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9820ea spreadtrum sc9630

sp7720ea_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7720ea spreadtrum sc8830

sp9820fpga_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9820fpga spreadtrum sc9630

sp9630eb4mn_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea4mn spreadtrum sc9630
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk

sp9830iea_4m_h100_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9830aea_5m_h100 spreadtrum sc9630

sp9830aea_5m_h100_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9830aea_5m_h100 spreadtrum sc9630

sp9830aeb_5m_h100_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9830aeb_5m_h100 spreadtrum sc9630

sp9830iea_5m_h100_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9830iea_5m_h100 spreadtrum sc9630

sp9630ea_a2800_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea_a2800 spreadtrum sc9630

sp9630ea_3592m_3mod_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea_3592m_3mod spreadtrum sc9630

coreprimelite_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 coreprimelite spreadtrum sc9630

coreprimelite_marlin_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 coreprimelite_marlin spreadtrum sc9630

sp9630ea_4mod_config   : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp9630ea_4mod spreadtrum sc9630
...
sp8730seea_jig_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8730seea_jig spreadtrum sc8830
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk

sp7731gea_hd2_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7731gea_hd2 spreadtrum sc8830
	#@echo "CONFIG_SECURE_BOOT = y" >> $(obj)include/config.mk
...
sp8830ec_nwcn_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8830ec_nwcn spreadtrum sc8830
...
sp8730sea_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8730sea spreadtrum sc8830

sp8730sea_openphone_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8730sea spreadtrum sc8830
...
sc9620openphone_zt_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sc9620openphone spreadtrum sc8830
...
tsharkwsamsung_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 tsharkwsamsung spreadtrum sc8830

pikeayoung2dtv_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 pikeayoung2dtv spreadtrum sc8830

core3_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 core3 spreadtrum sc8830
tshark2tabe_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 tshark2tabe spreadtrum sc8830

grandprime3g_ve_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 grandprime3g_ve spreadtrum sc8830

coreprime3g_ve_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 coreprime3g_ve spreadtrum sc8830

tshark2j2_3g_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 tshark2j2_3g spreadtrum sc8830

tizen_tm1_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 tizen_tm1 spreadtrum sc8830

grandprime_dtv_config     : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
...
clean:
	...
	@find $(OBJTREE) -type f \
		...
		| grep -v property | grep -v sc8800g | grep -v sc8800x | grep -v sc8810 | grep -v tiger | grep -v sc8825 | grep -v sc8830 | grep -v sc9630 \
...
clobber:	clean
	@find $(OBJTREE) \( -path ".*/property" -o -path ".*/sc8800g" -o -path ".*/sc8810" -o -path ".*/sc8825" -o -path ".*/sc8830" \
			   -o -path ".*/sc9630" -o -path ".*/sc8800x" -o -path ".*/nand_fdl" -o -path "nand_spl" -o -path ".*/tiger" \) \
