...
void board_init_f (ulong bootflag)
{
	...
	/*
	 * Fix me, when DDR size is less than or equal to 256M, uboot may destroy SPRD_SYSDUMP_MAGIC.
	...
	addr = CONFIG_SYS_SDRAM_BASE + PHYS_SDRAM_1_SIZE;
...
/*tempaily use for tiger to avoid died as refreshing LCD*/
    ...
    extern uint32_t sprdbat_get_vbatauxadc_caltype(void);
