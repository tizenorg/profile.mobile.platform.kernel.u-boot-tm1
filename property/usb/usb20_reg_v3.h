...
**---------------------------------------------------------------------------*/
#if 0
#define USB_REG_BASE  0x20200000	//(0x20300000) 
#endif
...
typedef union usb_grxstsp_tag
{
    struct usb_grxstsp_map
    {
        ...
        volatile unsigned int  frame_number                    :4;  //frame nummber
        volatile unsigned int  packet_status                   :4;  //packet status
        volatile unsigned int  data_pid                        :2;  //data PID
        volatile unsigned int  byte_count                      :11; //byte count
        volatile unsigned int  endpoint_number                 :4;  //endpoint nummber
      #else
	       volatile unsigned int 	endpoint_number 				:4;  //endpoint nummber
	       volatile unsigned int 	byte_count						:11; //byte count
	       volatile unsigned int 	data_pid						:2;  //data PID
...
typedef union usb_intsts_tag
{
    struct usb_intsts_map
    {
        ...
        volatile unsigned int sof               :1;	//12321 
        ...
        volatile unsigned int ginnakeff         :1;
        volatile unsigned int goutnakeff        :1;
        volatile unsigned int ulpickint         :1;	//13123	
        volatile unsigned int i2cint            :1;
        volatile unsigned int erlysusp          :1;
        volatile unsigned int usbsusp           :1;
        volatile unsigned int usbrst            :1;
